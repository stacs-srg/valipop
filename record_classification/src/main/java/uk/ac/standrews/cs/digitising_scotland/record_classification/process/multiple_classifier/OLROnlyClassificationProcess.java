...
public class OLROnlyClassificationProcess extends AbstractMultipleClassificationProcess {

    public static void main(final String[] args)  {

        try {
            OLROnlyClassificationProcess classification_process = new OLROnlyClassificationProcess();
    ...
    protected List<ClassificationProcess> getClassificationProcesses(String[] args) throws Exception {
        ...
        ClassificationProcess process = new OLRClassificationProcess(args);
