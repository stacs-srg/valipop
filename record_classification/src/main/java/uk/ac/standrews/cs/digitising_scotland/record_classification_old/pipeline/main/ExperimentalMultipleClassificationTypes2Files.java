...
import uk.ac.standrews.cs.digitising_scotland.record_classification_old.classifiers.closestmatchmap.CarsonSimilarity;
import uk.ac.standrews.cs.digitising_scotland.record_classification_old.classifiers.closestmatchmap.ClosestMatchMap;
import uk.ac.standrews.cs.digitising_scotland.record_classification_old.classifiers.closestmatchmap.SimilarityMetric;
import uk.ac.standrews.cs.digitising_scotland.record_classification_old.classifiers.closestmatchmap.SimilarityMetricFromSimmetricFactory;
import uk.ac.standrews.cs.digitising_scotland.record_classification_old.classifiers.closestmatchmap.StringSimilarityClassifier;
...
import uk.ac.standrews.cs.digitising_scotland.record_classification_old.datastructures.Pair;
...
import uk.ac.standrews.cs.digitising_scotland.record_classification_old.datastructures.vectors.VectorFactory;
import uk.ac.standrews.cs.digitising_scotland.record_classification_old.pipeline.BucketGenerator;
import uk.ac.standrews.cs.digitising_scotland.record_classification_old.pipeline.ClassifierPipeline;
import uk.ac.standrews.cs.digitising_scotland.record_classification_old.pipeline.ExactMatchPipeline;
import uk.ac.standrews.cs.digitising_scotland.record_classification_old.pipeline.IPipeline;
import uk.ac.standrews.cs.digitising_scotland.record_classification_old.pipeline.PipelineUtils;
