...
import uk.ac.standrews.cs.digitising_scotland.record_classification.classifier.NaiveBayesClassifier;
...
public class NaiveBayesClassificationProcess extends AbstractClassificationProcess {

    @SuppressWarnings("WeakerAccess")
    public NaiveBayesClassificationProcess(String[] args) throws Exception {

        super(args);
    }

    public NaiveBayesClassificationProcess(InputStreamReader gold_standard_data_reader, double training_ratio, int number_of_repetitions) throws Exception {
