 ...
 * @author Graham Kirby
 */
public abstract class AbstractClassificationProcess {
    ...
    private InfoLevel info_level = InfoLevel.LONG_SUMMARY;
    ...
    private void calculateClassificationMetrics(final ClassificationProcessState state) throws Exception {
        ...
        state.metrics = new ClassificationMetrics(state.confusion_matrix);
    }
    ...
    protected abstract String getClassifierDescription();
