...
import uk.ac.standrews.cs.digitising_scotland.record_classification.process.single_classifier.NaiveBayesClassificationProcess;

import java.util.Collections;
import java.util.List;

public class NaiveBayesOnlyClassificationProcess extends AbstractMultipleClassificationProcess {
...
//            logger.setLevel(Level.OFF);
            ...
            NaiveBayesOnlyClassificationProcess classification_process = new NaiveBayesOnlyClassificationProcess();
    ...
    protected List<ClassificationProcess> getClassificationProcesses(String[] args) throws Exception {
        ...
        ClassificationProcess process = new NaiveBayesClassificationProcess(args);
