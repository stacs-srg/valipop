 ...
 * The loss function is defined as the average confidence of all the {@link old.record_classification_old.datastructures.classification.Classification} in the set.
 * @author jkc25
 *
 */
