 ...
 * The loss function is defined as the sum of all the confidences in the {@link old.record_classification_old.datastructures.classification.Classification} set.
 * @author jkc25
 *
 */
