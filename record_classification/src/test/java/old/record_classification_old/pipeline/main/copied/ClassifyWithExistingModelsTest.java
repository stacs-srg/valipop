 ...
 */
package old.record_classification_old.pipeline.main.copied;
...
import old.record_classification_old.pipeline.main.ClassifyWithExistingModels;
import old.record_classification_old.pipeline.main.PIlot;
...
public class ClassifyWithExistingModelsTest {
    ...
    private final String expectedModelLocation = "/old/Models";
    ...
    private void copyFilesToExpectedLocation() throws IOException {
        ...
        File lookupTable1 = getResourceFile("/old/codModels/lookupTable.ser");
        File olrModel1 = getResourceFile("/old/codModels/olrModel");
