 ...
 */
package uk.ac.standrews.cs.digitising_scotland.record_classification_old.classifiers.closestmatchmap;
...
public class StringLengthSimilarityMetricTest {
    ...
    public static Collection<String[]> strings() {
        ...
        return Arrays.asList(new String[][]{{"boom", "bang"}, {"shake", "sheek"}, {"so long and", "thanks for all the fish"}, {"Einstein", "Schrodinger"}, {"cat in a ", "box"}, {"off she ", "hops"}, {"she", "jumps from the box"}});
    }
