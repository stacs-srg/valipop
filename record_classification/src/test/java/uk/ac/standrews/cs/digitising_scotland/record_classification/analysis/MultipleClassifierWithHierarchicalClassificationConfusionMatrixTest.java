...
public class MultipleClassifierWithHierarchicalClassificationConfusionMatrixTest {
    ...
    public void setUp() throws Exception {
        ...
        try (InputStreamReader reader = FileManipulation.getInputStreamReaderForResource(MultipleClassifierWithHierarchicalClassificationConfusionMatrixTest.class, CLASSIFIED_FILE_NAME)) {

            classified_records_csv = new DataSet(reader, ',');
        }
        try (InputStreamReader reader = FileManipulation.getInputStreamReaderForResource(MultipleClassifierWithHierarchicalClassificationConfusionMatrixTest.class, GOLD_STANDARD_FILE_NAME)) {
