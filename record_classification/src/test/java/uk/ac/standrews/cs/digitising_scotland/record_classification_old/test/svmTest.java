...
class svm_train {
    ...
    private static void exitWitHelp() {
        ...
        for (i = 0; i < argv.length; i++) {
            ...
            switch (argv[i - 1].charAt(1)) {
                ...
                case 'w':
                    ...
                    double[] oldDouble = param.weight;
                    param.weight = new double[param.nr_weight];
                    System.arraycopy(oldDouble, 0, param.weight, 0, param.nr_weight - 1);
    ...
    private void readProblem() throws IOException {
        ...
        try {
            while (true) {
                ...
                vector.addElement(atof(st.nextToken()));
