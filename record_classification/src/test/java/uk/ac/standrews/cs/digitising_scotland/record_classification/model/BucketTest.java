...
public class BucketTest {
    ...
    private static final Record[] RECORDS_WITH_DUPLICATE_IDS = new Record[]{
            new Record(1, "abc", new Classification("class1", new TokenList("abc"), 1.0)),
            new Record(2, "def", new Classification("class2", new TokenList("def"), 1.0)),
            new Record(2, "ghi", new Classification("class3", new TokenList("ghi"), 1.0)),
            new Record(3, "bcd", new Classification("class4", new TokenList("bcd"), 1.0)),
            new Record(4, "efg", new Classification("class5", new TokenList("efg"), 1.0))
    };
