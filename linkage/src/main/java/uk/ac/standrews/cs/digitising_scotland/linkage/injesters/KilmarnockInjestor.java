...
public class KilmarnockInjestor {
    ...
    private static final String[] ARG_NAMES = {"store_path","kilmarnock_births_path","kilmarnock_deaths_path","kilmarnock_marriages_path"};


    public KilmarnockInjestor( String store_path ) throws StoreException, RepositoryException, IOException {
            initialise( store_path );
    }

    private void initialise( String store_path ) throws StoreException, IOException, RepositoryException {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length >= ARG_NAMES.length) {
            ...
            String births_source_path = args[1];
            String deaths_source_path = args[2];
            String marriages_source_path = args[3];

            KilmarnockInjestor injestor = new KilmarnockInjestor( store_path );
