...
public class RelationshipFactory extends TFactory<Relationship> implements ILXPFactory<Relationship> {
    ...
    @Override
    public Relationship create(long persistent_object_id, JSONReader reader) throws PersistentObjectException {
        return new Relationship(persistent_object_id, reader);
    }
