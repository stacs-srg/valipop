 ...
 */
public class BridesMother extends Role {

    public BridesMother( Marriage marriage_record, long original_record_type) throws StoreException {

        super(marriage_record.getString(Marriage.BRIDE_MOTHERS_MAIDEN_SURNAME), marriage_record.getString(Marriage.BRIDE_MOTHERS_FORENAME), "F", role_played.brides_mother, marriage_record, original_record_type);
    }
