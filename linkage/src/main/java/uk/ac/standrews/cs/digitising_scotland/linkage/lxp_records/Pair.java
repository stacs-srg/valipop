...
public class Pair<T extends ILXP> extends LXP implements IPair<T> {
    ...
    public Pair(long persistent_Object_id, JSONReader reader, long required_type_labelID, IRepository repo, IBucket bucket) throws PersistentObjectException, IllegalKeyException {
        super(persistent_Object_id, reader, repo, bucket);
