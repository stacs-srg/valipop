...
public class SkyeIngestor {
    ...
    public SkyeIngestor(String store_path, String repo_name) throws StoreException, RepositoryException, IOException {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length >= ARG_NAMES.length) {
            ...
            SkyeIngestor injestor = new SkyeIngestor(store_path, repo_name);
