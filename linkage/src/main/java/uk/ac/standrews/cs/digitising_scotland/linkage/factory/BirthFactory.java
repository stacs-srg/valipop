...
public class BirthFactory extends TFactory<Birth> implements ILXPFactory<Birth> {
    ...
    @Override
    public Birth create(long persistent_object_id, JSONReader reader, IRepository repository, IBucket bucket) throws PersistentObjectException, IllegalKeyException {
        return new Birth(persistent_object_id, reader, repository, bucket);
    }
