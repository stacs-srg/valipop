...
mvn exec:java -q -Dexec.cleanupDaemonThreads=false -Dexec.mainClass="uk.ac.standrews.cs.digitising_scotland.verisim.implementations.FactorSearch" -e -Dexec.args="$2"
