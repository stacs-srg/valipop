...
public class PartneringStatsKey extends StatsKey {
    ...
    public PartneringStatsKey(Integer age, int forNumberOfFemales, CompoundTimeUnit consideredTimePeriod, Date currentDate) {
        this(age, forNumberOfFemales, consideredTimePeriod, currentDate, true);
    }

    public PartneringStatsKey(Integer age, int forNumberOfFemales, CompoundTimeUnit consideredTimePeriod, Date currentDate, boolean selfCorrection) {
        super(age, null, null, forNumberOfFemales, consideredTimePeriod, currentDate, selfCorrection);
    }
