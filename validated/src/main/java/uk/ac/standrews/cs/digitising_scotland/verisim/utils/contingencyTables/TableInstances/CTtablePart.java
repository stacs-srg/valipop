 ...
 */
package uk.ac.standrews.cs.digitising_scotland.verisim.utils.contingencyTables.TableInstances;

import uk.ac.standrews.cs.digitising_scotland.verisim.populationStatistics.recording.PopulationStatistics;
import uk.ac.standrews.cs.digitising_scotland.verisim.utils.contingencyTables.TableStructure.CTtable;
import uk.ac.standrews.cs.digitising_scotland.verisim.utils.contingencyTables.TableStructure.CTRow;
...
import uk.ac.standrews.cs.digitising_scotland.verisim.utils.contingencyTables.TreeStructure.VariableNotFoundExcepction;
...
public class CTtablePart extends CTtable {
    ...
    public CTtablePart(CTtree tree, PopulationStatistics inputStats) {
            ...
            if(leaf != null && leaf.getCount() != null) {
                try {
                    ...
                    if (Objects.equals(leaf.getVariable("Sex").getValue(), "FEMALE")) {
                        ...
                        leaf.discritiseVariable("Age", "PART", inputStats);
