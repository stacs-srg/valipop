...
/**
 * These tests check that when various populations are generated, and exported in GeoJSON format, then the file contains the expected content.
 *
 * @author Daniel Brathagen (dbrathagen@gmail.com)
 * @author Graham Kirby
 */
public class PopulationExportGeoJSONTest extends PopulationExportTest {
