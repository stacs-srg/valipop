...
@Tag("slow")
public class PopulationStructureSlowTest extends PopulationStructureTest {

    PopulationStructureSlowTest(final IPersonCollection population) {
    ...
    static List<Arguments> getTestCases()  {
        ...
        return getTestConfigurations(SLOW_TEST_CASE_INITIAL_POPULATION_SIZES_FOR_STRUCTURE_TESTS);
    }
}
