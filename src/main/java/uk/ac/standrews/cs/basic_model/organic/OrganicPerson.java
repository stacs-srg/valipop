...
import uk.ac.standrews.cs.basic_model.model.RandomFactory;
import uk.ac.standrews.cs.basic_model.organic.logger.LoggingControl;
import uk.ac.standrews.cs.basic_model.distributions.CauseOfDeathDistribution;
...
import uk.ac.standrews.cs.basic_model.distributions.OccupationDistribution;
import uk.ac.standrews.cs.basic_model.distributions.SurnameDistribution;
import uk.ac.standrews.cs.basic_model.distributions.UniformSexDistribution;
...
public class OrganicPerson implements IPerson {
     ...
     */
    public static void initializeDistributions(final OrganicPopulation population) throws NegativeDeviationException, NegativeWeightException, IOException, InconsistentWeightException {
     ...
     */
    public OrganicPerson(final int id, final int birthDay, final int parentPartnershipId, final OrganicPopulation population, final boolean seedGeneration, final OrganicPartnership spawningPartership) throws NegativeWeightException, NegativeDeviationException, InconsistentWeightException, IOException {
