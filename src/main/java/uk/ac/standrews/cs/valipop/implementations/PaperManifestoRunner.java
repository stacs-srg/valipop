...
public class PaperManifestoRunner {
    ...
    public static void main(String[] args) throws IOException, StatsException {
        ...
        String resultsPath = "/Users/tdalton/tom/phd/repos/population-model/src/main/resources/valipop/results";
        String configPath = "/Users/tdalton/tom/phd/repos/population-model/src/main/resources/valipop/config/scot/paper/";
