...
public abstract class Node<Op extends Comparable<Op>, cOp extends Comparable<cOp>, Count extends Number, ChildCount extends Number> {
    ...
    public ContingencyTableRow<Count> toContingencyTableRow() {

        final ContingencyTableRow<Count> row = (ContingencyTableRow<Count>) getParent().toContingencyTableRow();
        if (row != null)
            row.setVariable(getVariableName(), getOption().toString());
