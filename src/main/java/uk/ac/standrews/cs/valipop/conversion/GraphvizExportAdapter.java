 ...
 */
public class GraphvizExportAdapter extends AbstractFilePopulationWriter {
     ...
     */
    public GraphvizExportAdapter(final IPersonCollection population, final Path path) throws IOException {
