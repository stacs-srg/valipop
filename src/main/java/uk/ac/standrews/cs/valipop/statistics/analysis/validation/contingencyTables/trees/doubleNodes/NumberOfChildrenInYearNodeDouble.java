...
import static uk.ac.standrews.cs.valipop.statistics.analysis.validation.contingencyTables.tables.ContingencyTable.LABEL_NUMBER_OF_CHILDREN_IN_YEAR;
...
public class NumberOfChildrenInYearNodeDouble extends DoubleNode<Integer, IntegerRange> implements ControlSelfNode, ControlChildrenNode, RunnableNode {
    ...
    public String getVariableName() {
        return LABEL_NUMBER_OF_CHILDREN_IN_YEAR;
    }
