...
public class GEDCOMPartnership implements IPartnership {
    ...
    GEDCOMPartnership(final Family family, final GEDCOMImportAdapter adapter) {
    ...
    private static int getId(final String reference) {
        ...
        return GEDCOMExportAdapter.idToInt(reference);
    }
                ...
                if (event.getType() == FamilyEventType.MARRIAGE) {
                    ...
                    try {
                        if (event.getDate() != null)
                            marriageDate = LocalDate.parse(event.getDate().toString(), GEDCOMExportAdapter.FORMAT);
                    }
    ...
    private void setChildren(final Family family) {
        ...
        if (family.getChildren() != null)
            for (final IndividualReference child : family.getChildren())
                childIds.add(GEDCOMExportAdapter.idToInt(child.getIndividual().getXref()));
    }
