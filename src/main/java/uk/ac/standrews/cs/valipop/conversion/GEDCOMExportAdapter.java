...
/**
 * Implementation of population exporting to GEDCOM format file.
 *
 * @author Graham Kirby (graham.kirby@st-andrews.ac.uk)
 * @author Alan Dearle (alan.dearle@st-andrews.ac.uk)
 */
public class GEDCOMExportAdapter extends AbstractFilePopulationWriter {
     ...
     */
    public GEDCOMExportAdapter(final Path path) throws IOException {
