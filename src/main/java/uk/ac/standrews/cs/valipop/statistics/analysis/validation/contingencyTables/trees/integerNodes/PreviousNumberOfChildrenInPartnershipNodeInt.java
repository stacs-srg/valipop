...
import static uk.ac.standrews.cs.valipop.statistics.analysis.validation.contingencyTables.tables.ContingencyTable.LABEL_NUMBER_OF_PREVIOUS_CHILDREN_IN_PARTNERSHIP;
...
public class PreviousNumberOfChildrenInPartnershipNodeInt extends IntNode<IntegerRange, IntegerRange> {
    ...
    public String getVariableName() {
        return LABEL_NUMBER_OF_PREVIOUS_CHILDREN_IN_PARTNERSHIP;
    }
