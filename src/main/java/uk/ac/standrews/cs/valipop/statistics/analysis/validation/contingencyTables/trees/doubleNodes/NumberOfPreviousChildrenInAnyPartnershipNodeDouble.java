...
import uk.ac.standrews.cs.valipop.statistics.analysis.validation.contingencyTables.trees.*;
import uk.ac.standrews.cs.valipop.utils.specialTypes.labeledValueSets.IntegerRange;

import java.time.LocalDate;
import java.time.Year;

import static uk.ac.standrews.cs.valipop.statistics.analysis.validation.contingencyTables.tables.ContingencyTable.LABEL_NUMBER_OF_PREVIOUS_CHILDREN_IN_ANY_PARTNERSHIP;
...
public class NumberOfPreviousChildrenInAnyPartnershipNodeDouble extends DoubleNode<IntegerRange, Boolean> implements RunnableNode, ControlChildrenNode {
    ...
    public void processPerson(IPerson person, LocalDate currentDate) {
        ...
        if (activePartnership == null) {
            ...
            option = Utilities.getChildrenBirthedInYear(activePartnership, Year.of(currentDate.getYear())) != 0;
        }
    ...
    public String getVariableName() {
        return LABEL_NUMBER_OF_PREVIOUS_CHILDREN_IN_ANY_PARTNERSHIP;
    }
