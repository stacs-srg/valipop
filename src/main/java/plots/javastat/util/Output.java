...
public enum Output {
    ...
    public String description() {
        switch (this) {
            ...
            case PROPORTION_H0:
                return
                        "Description: the sample proportion under the null " +
                                "hypothesis;\n" +
                                "Class: TwoSampProps";
            case PROPORTION_DIFFERENCE_SE_H0:
                return
                        "Description: the standard error of the sample proportion " +
            ...
            case LINEAR_DISCRIMINANTS:
                return
                        "Description: the linear discriminants;\n" +
                                "Class: DiscriminantAnalysis";
            case PREDICTED_GROUP:
                return
            ...
            case SURVIVAL_ESTIMATE_VARIANCE:
                return
