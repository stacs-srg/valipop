...
import plots.javastat.inference.ChisqTest;
import plots.javastat.inference.OneWayANOVA;
import plots.javastat.inference.nonparametric.RankSumTest;
import plots.javastat.inference.nonparametric.SignRankTest;
import plots.javastat.inference.onesample.OneSampProp;
import plots.javastat.inference.onesample.OneSampMeanTTest;
import plots.javastat.inference.onesample.OneSampMeanZTest;
import plots.javastat.inference.twosamples.TwoSampProps;
import plots.javastat.inference.twosamples.MatchedSampMeansTTest;
import plots.javastat.inference.twosamples.MatchedSampMeansZTest;
import plots.javastat.inference.twosamples.TwoSampMeansTTest;
import plots.javastat.inference.twosamples.TwoSampMeansZTest;
...
public class StatisticalTests extends StatisticalAnalysis
{
     ...
     *                 "Wilcoxon", "SignRank", "RankSum", "Paired Z","Paired T",
     *                 "T";
