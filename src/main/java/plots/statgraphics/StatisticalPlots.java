...
import plots.statgraphics.eda.BarPlot;
import plots.statgraphics.eda.BoxPlot;
import plots.statgraphics.eda.Histogram;
import plots.statgraphics.eda.LinePlot;
import plots.statgraphics.eda.PiePlot;
import plots.statgraphics.eda.ScatterPlot;
import plots.statgraphics.eda.TimeSeriesPlot;
...
public class StatisticalPlots extends GraphicalAnalysis
{
     ...
     * <br> PLOT_TYPE: the enum in the class TestType or the choices "BAR",
     *                 "BOX", "HISTOGRAM", "LINE","PIE", "TIME_SERIES",
     *                 "LINEAR_REGRESSION", "SURVIVAL" and "SCATTER";
     * <br><br>
